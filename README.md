...
1. Configure in `.env`:
   ...
   - `CURSOR_SETTINGS_DIR=/home/user/.cursor`
   - `CURSOR_CONFIG_DIR=/home/user/.config/Cursor`
   - `CURSOR_LOCAL_BIN_DIR=/home/user/.local/bin`
   - `CURSOR_AGENT_HOME_DIR=/home/user/.local/share/cursor-agent`
2. Start service:
