---
name: issue-handler-cli
description: Issue handler CLI design and workflow documentation — the Gitea issue automation pipeline (architect gate, developer stage, status protocol). Historical reference for the fabric.
---
