...
description: Global working agreements for agents in the fabric. Read engineering-principles first — its rules are inviolable and override this skill on conflict.
---
