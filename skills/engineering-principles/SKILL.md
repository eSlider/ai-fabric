...
description: Engineering principles (inviolable) for the software-delivery fabric. Use before any code, architecture, or review decision — reuse-first, Occam/YAGNI, no mocks, YAML over JSON.
---
